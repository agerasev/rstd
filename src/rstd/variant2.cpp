...
rtest_module_(variant2) {
    ...
    rtest_(move) {
        ...
        auto a = Variant<rstd::Tuple<>, std::unique_ptr<int>>::create<1>(std::move(ptr));
        //auto b = a;
        assert_eq_(*a.get<1>(), 123);
        ptr = a.take<1>();
        assert_eq_(*ptr, 123);
    ...
    rtest_(ctor_dtor) {
        ...
        {
            auto a = Variant<rstd::Tuple<>, std::shared_ptr<int>>::create<1>(ptr);
    ...
    rtest_(bool) {
        auto a = Variant<rstd::Tuple<>, int, bool>::create<1>(123);
        assert_eq_(a.get<1>(), 123);

        auto b = Variant<rstd::Tuple<>, int, bool>::create<2>(true);
