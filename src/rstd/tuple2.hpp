...
template <typename ...Elems>
struct fmt::Display<rstd2::Tuple<Elems...>> {
private:
    template <size_t ...I>
    static void print(std::ostream &o, const rstd2::Tuple<Elems...> &t, std::index_sequence<I...>) {
        (..., write_(o, "{}{}", (I == 0 ? "" : ", "), t.template get<I>()));
    }

public:
    static void fmt(const rstd2::Tuple<Elems...> &t, std::ostream &o) {
        o << "(";
        print(o, t, std::make_index_sequence<rstd2::Tuple<Elems...>::size()>());
        o << ")";
    }
};
